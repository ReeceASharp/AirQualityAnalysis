...
public class EastWestSO2Job {
    public static void main(String[] args) {
        try {
            ...
            // Current class.
            job1.setJarByClass(EastWestSO2Job.class);

            //Mapper, Combiner, Reducer
            job1.setMapperClass(EWMapperOne.class);
            job1.setCombinerClass(EWReducerOne.class);
            job1.setReducerClass(EWReducerOne.class);
